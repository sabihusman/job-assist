...
- **Triage** — Three layers: (1) hard rules — closed channel, role filter, staffing firm, employer blocklist, geo, salary floor, applicant cap (PR #23, see [ADR-008](DECISIONS.md#adr-008--hard-rule-filter--rules-priority-and-defaults) and [ADR-013](DECISIONS.md#adr-013--employer-company_blocklist-hard-rule)); (2) embedding similarity against profile (Week 3); (3) LLM verdict on top-N only (Week 3-4).
